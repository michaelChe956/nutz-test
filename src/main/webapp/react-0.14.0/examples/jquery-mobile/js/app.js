...
var PageOneContent = React.createClass({
  ...
  render: function() {
    return React.DOM.div(null,
      ...
      React.DOM.p(null, 'Just views the source and copy the code to get started. All the CSS and JS is linked to the jQuery CDN versions so this is super easy to set up. Remember to include a meta viewport tag in the head to set the zoom level.'),
      React.DOM.p(null,
